(function registerUiSwitch(globalScope: typeof globalThis) {
  ...
  // Preserve the existing CSS hooks while sharing the icon/label/status presentation.
  function createStatusSwitch(
  ...
  namespace.uiSwitch = { createStatusSwitch };
})(globalThis);
