(function registerUiIcons(globalScope: typeof globalThis) {
  ...
  namespace.uiIcons = {
    createClassicChevronIcon,
    createSearchIcon,
    createBreadcrumbChevronIcon,
    createExternalLinkIcon,
    createFavoriteStarIcon,
    createLabIcon,
    createBackIcon,
    createForwardIcon,
    createCategoryIcon,
    createAudioIcon,
    createPasswordVisibilityIcon,
    createLandingExternalLinkIcon,
    createAnnouncementMegaphoneIcon,
    createInfoMarker,
  };
})(globalThis);
